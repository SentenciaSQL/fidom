...
/**
 * Strings for component 'filter_embedquestion', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['invalidquestion'] = 'La pregunta con idnumber "{$a->qid}" no existe en categoría "{$a->catname}".';
