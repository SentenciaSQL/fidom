...
/**
 * Strings for component 'tool_moodlebox', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['badpowersupply'] = '<p><b>¡Advertencia!</b> ¡La fuente de poder de la MoodleBox es inadecuada, lo cual puede causar varios problemas, como por ejemplo una limitación en el número de clientes Wi-Fi o inclusive un apagón inesperado del dispositivo.</p><p>Se le recomienda encarecidamente que <b>cambie la fuente de poder</b>, dándole preferencia a la <a href="https://www.raspberrypi.org/products/raspberry-pi-universal-power-supply/" target="_blank">fuente de poder  oficial de la Fundación Raspberry</a>, y que use un cable de alta calidad para conectarla a la MoodleBox.</p>';
...
$string['interfacename'] = 'Nombre de interfase';
...
$string['networkinterface'] = 'Interfase cableada de red';
