...
/**
 * Strings for component 'tool_userrestore', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
<p>Sin embargo, es posible que su Nombre de usuario no haya sido capturado correctamente debido a la forma en la que Moodle maneja la eliminación de usuarios y el hecho de que se hayan o  no limpiado las bitácoras de eventos. Su Nombre de usuario es  {username}</p>
...
<li>{username} - Nombre de usuario del usuario restaurado (esto PODRÍA ser diferente del que existía antes de que la cuenta fuera eliminada)</li>
...
<li>{loginlink} - Enlace para ingresar al sitio (basada en el Nombre de usuario restaurado)</li>
</ul>';
...
$string['restore:username-exists'] = 'No puede restaurarse usuario: el Nombre de usuario \'{$a->username}\' ya existe para un usuario activo diferente';
