...
/**
 * Strings for component 'tool_mergeusers', language 'es_mx', branch 'MOODLE_37_STABLE'
 *
...
$string['form_description'] = '<p>Usted puede buscar usuarios aquí si no conoce el Nombre de usuario o el número_ID  del usuario. De lo contrario, Usted puede expander el formato para ingresar esa información directamente. Por favor, vea la ayuda en los campos para más información</p>';
...
$string['searchuser_help'] = 'Escriba un Nombre de usuario, nombre/apellido(s), dirección Email, o la ID del usuario para buscar a usuarios potenciales. Usted también puede especificar si solamente desea buscar en un campo particular.';
