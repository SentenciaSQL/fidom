...
/**
 * Strings for component 'tool_certification', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['addnewcertification'] = 'Añadir nueva certificación';
$string['afterallocation'] = 'Después de asignación';
...
$string['allocationnoteditable'] = 'Asignación no editable';
...
$string['certificationcreated'] = 'Certificación creada';
...
$string['certifiedcertifications'] = 'certificaciones certificadas';
...
$string['conditionuserallocated'] = 'Usuario asignado a certificación';
...
$string['dateisonorafter'] = 'Fecha es en o después de';
...
$string['errorcannotduplicate'] = 'No puede duplicar';
...
$string['errorcertificationisarchived'] = 'Certificación sea lograda';
$string['errorcertificationmustbearchived'] = 'Certificación debe ser lograda';
...
$string['errorinvalidcertificationstatus'] = 'Estatus de certificación inválido';
...
$string['errorusernotallocated'] = 'El usuario no está asignado en certificación';
...
$string['expiredcertifications'] = 'certificaciones expiradas';
...
$string['fullname'] = 'NombreCompleto';
$string['futureallocation'] = 'Asignación futura';
$string['helperactionnotallowed'] = 'Acción ayudante no permitida';
$string['idnumber'] = 'Número ID';
$string['manageprograms'] = 'Gestionar programas';
$string['manual'] = 'Manual';
$string['markcertifysuspendnotice'] = 'Suspender usuario del programa';
$string['markprogramnotcompleted'] = 'Marcar programa como no completado';
$string['markprogramnotcompleted_help'] = 'Marcar programa relacionado a estas certificaciones como no completado para este usuario';
...
$string['notificationsubjectcertificationuserallocated'] = 'Asignado a certificación \'{$a}\\';
$string['notificationsubjectcertificationuserdeallocated'] = 'Des-asignado de certificación \'{$a}\\';
$string['notset'] = 'No configurado';
$string['nousersselected'] = 'Por favor seleccione al menos un usuario';
$string['ongoingcertifications'] = 'certificaciones en curso';
$string['ongoingcertificationslink'] = '<a href="{$a->href}">Certificaciones en cursos: {$a->count}</a>';
$string['onorafter'] = 'en o después de';
$string['open'] = 'Abierto';
...
$string['privacy:metadata:certification_users:duedate'] = 'La fecha esperada de la certificación.';
$string['privacy:metadata:certification_users:duedatelocked'] = 'Si es que la fecha esperada por defecto está anulada.';
$string['privacy:metadata:certification_users:enddate'] = 'La fecha del fin de la certificación.';
$string['privacy:metadata:certification_users:enddatelocked'] = 'Si es que la fecha de final esperada predeterminada está anulada.';
$string['privacy:metadata:certification_users:expirydate'] = 'La fecha de expiración de la certificación para este usuario.';
$string['privacy:metadata:certification_users:expirydatelocked'] = 'Si es que la fecha de expiración predeterminada está anulada';
$string['privacy:metadata:certification_users:startdate'] = 'La fecha de inicio de la certificación';
$string['privacy:metadata:certification_users:startdatelocked'] = 'Si es que la fecha de inicio predeterminada está anulada.';
...
$string['relativeallocationdate'] = 'Relativo a fecha de asignación';
...
$string['reportuseroverduedcerts'] = 'Certificaciones retrasadas';
$string['requirerecertification'] = 'Requerir certificación';
$string['resetallcoursesprogram'] = 'Reiniciar todos los cursos en este programa';
$string['resetallcoursesprogram_help'] = 'Reiniciar todos los cursos para este usuario en el programa relacionado con esta certificación';
...
$string['selectadifferentprogram_help'] = 'Seleccionar un programa diferente para la re-certificación';
$string['selectcertification'] = 'Certificación';
...
$string['suspendprogallocation'] = 'Suspender asignación de programa';
$string['suspendprogallocation_help'] = 'Si el programa no está suspendido, el programa aparecerá en el Tablero del usuario como no completado sin fecha esperada';
$string['tagarea_tool_certification'] = 'Certificaciones';
$string['tags'] = 'Marcas';
$string['tags_help'] = 'Ayuda de marcas';
...
$string['warningcertificationprogram'] = 'Advertencia: Una vez que una certificación es creada esta configuración ya no será editable.';
