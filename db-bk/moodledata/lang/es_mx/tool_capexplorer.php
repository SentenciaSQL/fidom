...
$string['error:invalidusername'] = 'No hay un usuario con el Nombre de usuario de "{$a}"';
$string['error:missingcapability'] = 'Usted debe escribir una capacidad';
$string['error:missingusername'] = 'Usted debe escribir un Nombre de usuario';
...
$string['username_help'] = '<p>Seleccione un usuario a revisar.</p><p>Esta campo usa autocompletar, por lo que al empezar a escribir un Nombre de usuario, direción Email o Nombre-del-Usuario, aparecerán opciones entre las que podrá elegir.</p>';
$string['usernameplaceholder'] = 'Escriba nombre, Nombre de usuario o Email';
