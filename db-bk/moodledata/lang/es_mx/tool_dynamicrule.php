...
/**
 * Strings for component 'tool_dynamicrule', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['conditionuserenrolleddescriptionwithenrol'] = 'Usuarios que están inscritos en curso \'{$a->course}\' con método de inscripción \'{$a->enrol}\\';
$string['conditionuserlastlogin'] = 'Último ingreso del usuario';
$string['conditionuserlastlogindescriptionbefore'] = 'Usuarios cuyo último ingreso fue {$a} en el pasado';
$string['conditionuserlastlogindescriptionever'] = 'Usuarios que han ingresado al menos una vez';
$string['conditionuserlastlogindescriptioninlast'] = 'Usuarios cuyo último ingreso fue en el último {$a}';
...
$string['datetypeinlast'] = 'En los últimos';
...
$string['matchedtime'] = 'Tiempo concordado';
...
$string['notifymanagers'] = 'Notificar al mánager acerca de los usuarios que concordaron con condiciones';
$string['notifyowner'] = 'Notificar al propietario de la regla';
...
$string['rulematchfreq'] = 'Frecuencia de concordancia';
$string['rulematchfreqdesc0'] = 'No puede ser disparada más de';
$string['rulematchfreqdesc1'] = 'veces';
$string['rulematchfreqenable'] = 'Habilitar limitación de frecuencia coincidente';
...
$string['selectbadge_help'] = 'Seleccionar insignia a emitir';
