...
/**
 * Strings for component 'block_remlab_manager', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['delete_enlarge_keys'] = 'Eliminar teclas AGRANDAR';
$string['delete_existing_local_experience'] = 'Eliminar experiencia local';
$string['enlargedesigner'] = 'Diseñador AGRANDAR';
$string['enlargedesigner_desc'] = 'Diseñadores AGRANDAR pueden crear, eliminar, editar y usar experiencias AGRANDAR';
$string['enlarge_header'] = 'Configurar AGRANDAR para esta instancia de bloque';
$string['enlarge_lti_url'] = 'URL hacia actividad AGRANDAR LTI';
$string['enlargemanager'] = 'Mánager AGRANDAR';
$string['enlargemanager_desc'] = 'Mánagers AGRANDAR pueden editar y usar experiencias AGRANDAR existentes';
...
$string['go_to_enlarge'] = 'Ir a AGRANDAR';
...
$string['myFrontier_IP'] = 'Nombre y dirección IP del servidor AGRANDAR';
$string['myFrontier_port'] = 'Puerto(s) de comunicación AGRANDAR';
$string['or'] = 'o';
...
$string['synchronise_myFrontier_users'] = 'Sincronizar usuarios AGRANDAR';
