...
/**
 * Strings for component 'autoattendmod', language 'es_mx', branch 'MOODLE_37_STABLE'
 *
...
$string['email_enable_title'] = 'Notificación Email a Profesores (Resultado)';
...
$string['username_manage'] = 'Gestión del Nombre de usuario';
