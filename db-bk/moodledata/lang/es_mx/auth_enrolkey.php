...
/**
 * Strings for component 'auth_enrolkey', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
<li>De allí en eadelante Usted solamente necesitará ingresar su Nombre de usuario y su contraseña personales (en el formato en esta página) para ingresar al sitio y acceder a cualquier curso(s) en que se hubiera inscrito.</li>
</ol>';
