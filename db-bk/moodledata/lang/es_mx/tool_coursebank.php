...
/**
 * Strings for component 'tool_coursebank', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
...
$string['settings_proxyuser'] = 'Nombre de usuario';
$string['settings_proxyuser_desc'] = 'Credencial de Nombre de usuario del proxy';
