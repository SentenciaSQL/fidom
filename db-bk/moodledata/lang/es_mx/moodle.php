...
/**
 * Strings for component 'moodle', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   moodle
...
$string['createuserandpass'] = 'Elegir su Nombre de usuario y contraseña';
...
$string['emailexistshintlink'] = 'Recuperar Nombre de usuario o contraseña olvidada';
...
$string['invalidusername'] = 'El Nombre de usuario solamente puede contener caracteres alfanuméricos en minúsculas, (letras y números), subrayado (_), guión (-), punto (.) o arroba (@).';
...
Su nueva información de acceso es: Nombre de usuario : {$a->username} Contraseña: {$a->newpassword}
...
La información para ingresar es: Nombre de usuario : {$a->username} contraseña: {$a->newpassword} (deberá cambiar su contraseña cuando ingrese por primera vez)
...
$string['registrationyes'] = 'Si, notifíquenme sobre nuevas versiones liberadas de Moodle,alertas de seguridad y otras noticias importantes';
...
$string['usernameemail'] = 'Nombre de usuario / Email';
