...
/**
 * Strings for component 'bigbluebuttonbn', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['config_muteonstart_description'] = 'Estas configuraciones habilitan o deshabilitan opciones en la Interfase del Usuario y también definen valores predeterminados para estas opciones.';
...
$string['config_recording_all_from_start_editable_description'] = 'Si se activa la interfase incluye una opción para la característica de habilitar y deshabilitar la grabación de todo desde el inicio.';
...
$string['config_recording_hide_button_editable_description'] = 'Si se activa la interfase incluye una opción para la habilitar y deshabilitar la característica de ocultar el botón de grabación.';
