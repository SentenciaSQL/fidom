...
/**
 * Strings for component 'auth_antihammer', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['blockusername'] = '¿Bloquear por Nombre de usuario ?';
...
$string['err:blocked:user'] = 'Insistencia detectada: Nombre de usuario= {$a->username} dirección IP = {$a->ip} (IP y/o Nombre de usuario está bloqueado)';
...
<p>El bloque se ha hecho activo para la dirección IP {$a->ip}, Nombre de usuario{$a->username}</p>
...
$string['privacy:metadata:auth_antihammer_log:data'] = 'Informacion serializada almacenada para este usuario, la cual es una versión serializada de los datos anti-martilleo incluyendo Nombre de usuario y dirección IP.';
...
$string['privacy:metadata:auth_antihammer:username'] = 'El Nombre de usuario intentado en Moodle para el cual el martilleo está temporalmente anotado en bitácora.';
...
$string['thead:username'] = 'Nombre de usuario';
