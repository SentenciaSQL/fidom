...
/**
 * Strings for component 'tool_reportbuilder', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['datadisplay'] = 'Visualización de datos';
$string['datadisplay_opt1'] = 'De acuerdo al observador';
$string['datadisplay_opt2'] = 'Como el usuario actual ({$a})';
...
$string['displaydata'] = 'Mostrar datos del reporte';
...
$string['entitydatastoreaction'] = 'Acción Datastor';
$string['entitydatastorecourse'] = 'Curso de Datastore';
$string['entitydatastoreuser'] = 'Usuario de Datastore';
...
$string['error:mustselectrecurrence'] = 'Usted debe seleccionar una recurrencia.';
$string['error:mustselectreport'] = 'Usted debe seleccionar un reporte.';
...
$string['privacy:metadata'] = 'El constructor de reportes solamente muestra datos almacenados en otros lugares.';
...
$string['resetalltitle'] = 'Reiniciar todas las condiciones';
$string['resetcondition'] = 'Reiniciar condiciones';
$string['resetfield'] = 'Reiniciar campo \'{$a}\'';
$string['resettitle'] = 'Reiniciar condición';
...
$string['schedulesstab'] = 'Horarios-Agendas';
$string['scheduletab'] = 'Agendar';
...
$string['shedulewarning'] = 'Los reportes agendados siempre mostrarán la misma información tal como la ve el creador del reporte.';
...
$string['timecompleted'] = 'Hora finalizado';
$string['togglestatus'] = 'Alternar estado';
...
$string['visibleto'] = 'Visible a usuarios en';
