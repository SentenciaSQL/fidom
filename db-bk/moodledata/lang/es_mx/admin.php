...
/**
 * Strings for component 'admin', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   admin
...
$string['configenablesafebrowserintegration'] = 'Agrega la opción "Requerir Navegador de Examen Seguro" para el campo "Seguridad del navegador "en el formato de configuración del examen. Ver http://www.safeexambrowser.org/ para más información. Nota: los exámenes seguros requieren que la computadora y el navegador estén correctamente configurados, lo que no siempre sucede en los cafés internet y las casas de los usuarios de México.';
...
$string['configprotectusernames'] = 'Si se habilita, no se mostrarán pistas que permitan adivinar  el Nombre de usuario o la dirección de Email en el formato de contraseña olvidada .';
