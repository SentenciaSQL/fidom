...
/**
 * Strings for component 'block_autoattend', language 'es_mx', branch 'MOODLE_37_STABLE'
 *
...
$string['page_column_size_desc'] = 'Se muestra un Nombre de usuario para cada número de columnas de esto.';
