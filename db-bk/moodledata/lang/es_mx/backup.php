...
/**
 * Strings for component 'backup', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   backup
...
$string['importgeneralduplicateadminallowed_desc'] = 'Si el sitio tiene una cuenta con el Nombre de usuario \'admin\', entonces el intentar restaurar un archivo de respaldo que contenga un Nombre de usuario \'admin\' puede causar un conflicto. Si se habilita esta configuración, el conflicto será resuelto al cambiar el Nombre de usuario en el archivo de respaldo a admin_xyz\'.';
