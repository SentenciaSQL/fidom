...
/**
 * Strings for component 'hvp', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   hvp
...
$string['enabledlrscontenttypes_help'] = 'Hace posible el utilizar tipos de contenido que dependen de un Learning Record Store para funcional adecuadamente, como el tipo de contenido de Cuestionario (Questionnaire).';
