...
/**
 * Strings for component 'auth_oidc', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   auth_oidc
...
$string['cfg_loginflow_rocreds'] = 'Autenticación por Nombre de usuario/Contraseña';
...
$string['errorauthdisconnectusernameexists'] = 'Ese Nombre de usuario ya está tomado. Por favor, elija uno diferente.';
...
$string['privacy:metadata:auth_oidc_token:oidcusername'] = 'El Nombre de usuario del usuario OIDC';
...
$string['privacy:metadata:auth_oidc_token:username'] = 'El Nombre de usuario del usuario Moodle';
$string['ucp_disconnect_details'] = 'Esto desconectará su cuenta Moodle de {$a}. Usted necesitará crear un Nombre de usuario y contraseña para ingresar a Moodle.';
$string['ucp_disconnect_title'] = '{$a} Desconexión';
$string['ucp_login_start'] = 'Comenzar a usar {$a} para ingresar a Moodle';
$string['ucp_login_start_desc'] = 'Esto cambiará su cuenta para que use {$a} para ingresar a Moodle. Una vez habilitado, Usted ingresará usando sus credenciales de {$a} - su Nombre de usuario y contraseña actuales de Moodle no funcionarán. Usted puede desconectar su cuenta en cualquier momento y regresar a ingresar normalmente.';
