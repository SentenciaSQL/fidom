...
/**
 * Strings for component 'enrol_arlo', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   enrol_arlo
...
$string['apiusername'] = 'Nombre de usuario Arlo';
...
* Nombre de usuario del susuario {$a->username}
...
$string['emaillocalpart_desc'] = 'Usar dirección del Nombre de usuario del Email antes del símbolo de @';
$string['emaillocalpartrandomnumber'] = 'Parte local del Email y número aleatorio';
$string['emaillocalpartrandomnumber_desc'] = 'Usar dirección del Nombre de usuario del Email antes del símbolo de @ + número aleatorio';
...
$string['usernamegeneration_desc'] = '<p>El orden en el cual son usados diferentes formatos de Nombre de usuario para generar un Nombre de usuario para una nueva cuenta en Moodle. Si se encontró una cuenta existente con el mismo Nombre de usuario que el generado, el siguiente formato  será intentado..</p><br>';
...
Su Nombre de usuario: {$a->username}
