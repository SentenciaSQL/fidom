...
/**
 * Strings for component 'booking', language 'es_mx', branch 'MOODLE_37_STABLE'
 *
 * @package   booking
...
$string['banusernameswarning'] = 'Su Nombre de usuario está prhibido, por lo que Usted no puede reservar.';
...
$string['bookingmanagererror'] = 'El Nombre de usuario escrito no es válido. Puede ser que no exista o que haya más de un usuario con este Nombre de usuario (por ejemplo, si Usted tiene habilitadas autenticaciones por Mnet y locales)';
...
$string['usernameofbookingmanager'] = 'Nombre de usuario del mánager de reservaciones';
$string['usernameofbookingmanager_help'] = 'Nombre de usuario del usuario que se mostrará en el campo "De" de las notificaciones de confirmación. Si está habilitada la opción para "Enviar Email de confirmación al Mánager de reservaciones", éste será el usuario quien recibe  una copia de las notificaciones de confirmación.';
