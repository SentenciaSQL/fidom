...
/**
 * Strings for component 'report_roster', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['settings:show_username'] = 'Mostrar Nombre de usuario';
$string['settings:show_username:description'] = 'Mostrar Nombre de usuario debajo del nombre completo en el Reporte de la Lista';
