...
$string['core.cannotconnect'] = '<strong>No se puede conectar</strong>: Verifique que Usted escribió correctamente la dirección de su sitio.';
...
$string['core.login.credentialsdescription'] = 'Por favor proporcione su Nombre de usuario y contraseña para ingresar.';
...
$string['core.login.faqtestappanswer'] = 'Para probar la App en un sitio Moodle Demo, escriba "teacher" o "student" en el campo para "La dirección de su sitio" y elija el botón para "¡Conectar!" .';
$string['core.login.faqtestappquestion'] = 'Solamente quiero probar la App. ¿Qué puedo hacer?';
$string['core.login.faqwhatisurlanswer'] = '<p>Cada organización o escuela tiene su propia dirección personalizada para su sitio Moodle.</p><p>Para encontrar la dirección de su sitio Moodle con el cual Usted quiere conectarse, haga lo siguiente:</p><ol><li>Abra un navegador web y vaya a la página para ingresar al sitio Moodle de su organización o escuela</li><li>En la parte superior de la página, en la barra de dirección, Usted verá la URL de su sitio Moodle. Por ejemplo "campus.example.edu".{{$image}}</li><li>Copie la dirección (no copie la parte de  /login y lo que sigue después), péguelo en la App Moodle y haga clic en ¡Conectar!"</li><li>Ahora Usted puede ingresar a su sitio, usando su Nombre de usuario y contr</li>';
$string['core.login.faqwhatisurlquestion'] = '¿Cual es la URL de mi sitio Moodle? ¿Cómo encuentro el sitio de mi escuela?';
...
$string['core.login.problemconnectingerror'] = 'Estamos teniendo dificultades para conectar';
...
$string['core.login.siteaddress'] = 'La dirección de su sitio';
