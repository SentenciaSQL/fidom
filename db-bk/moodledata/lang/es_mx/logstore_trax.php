...
/**
 * Strings for component 'logstore_trax', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['lrs_username'] = 'Nombre de usuario LRS (HTTP Básico)';
$string['lrs_username_help'] = 'Estea es el Nombre de usuario de la cuenta HTTP Básico creada en su LRS.';
