...
/**
 * Strings for component 'filter_generico', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['credentialsinvalid'] = 'El secreto y el Nombre de usuario API no pudieron ser usados para obtener acceso. Por favor revíselos.';
