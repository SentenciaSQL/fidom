...
/**
 * Strings for component 'readaloud', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   readaloud
...
$string['apiuser_details'] = 'El Nombre de usuario de cuenta Poodll que autoriza Poodlll en este sitio.';
...
$string['da-dk'] = 'Danés (DK) (solamente transcripción rápida)';
...
$string['enablepreview'] = 'Habilitar previsualización';
$string['enablepreview_details'] = 'El modo de previsualización muestra lal ectura y audio modelo a los estudiantes antes de que comience la actividad';
$string['enableshadow'] = 'Habilitar Sombreado';
$string['enableshadow_details'] = 'El modo Sombreado reproduce el audio modelo conforme los estudiantes leen en voz alta.';
...
$string['transcriber_amazontranscribe'] = 'Transcripción Regular (AWS)';
$string['transcriber_details'] = 'El motor de transcripción a usar. La transcripción instantánea solamente funciona si el idioma del pasaje es Inglés US/AU/GB y Francés FR/CA, y cuando se usan regiones AWS US/Dublin/Sydney/Irlanda';
