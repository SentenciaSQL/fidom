...
/**
 * Strings for component 'plagiarism_plagscan', language 'es_mx', branch 'MOODLE_36_STABLE'
 *
...
$string['badcredentials'] = 'PlagScan no reconoció los detalles de la cuenta - por favor confirme que URL del servidor, Nombre de usuario ({$a->user}), clave API y número de versión ({$a->version}) sean correctos';
...
$string['plagscan_client_username'] = 'Nombre de usuario del Cliente';
