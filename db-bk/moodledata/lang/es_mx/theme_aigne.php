...
/**
 * Strings for component 'theme_aigne', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   theme_aigne
...
$string['bgrepeat'] = 'posición del fondo de página';
...
$string['usermoodle'] = 'En el encabezado, en el estilo antiguo de Moodle (ingresar + saludo + Nombre de usuario + Salir)';
