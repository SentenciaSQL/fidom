...
/**
 * Strings for component 'block_coupon', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['label:api_user_desc'] = 'El Nombre de usuario que puede ser usado para generar un cupón usando la API.';
