...
/**
 * Strings for component 'customcertelement_daterange', language 'es_mx', branch 'MOODLE_37_STABLE'
 *
...
$string['error:enddate'] = 'La Fecha de fin debe  ser después de la Fecha de inicio';
