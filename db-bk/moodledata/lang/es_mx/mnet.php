...
/**
 * Strings for component 'mnet', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   mnet
...
$string['enterausername'] = 'Por favor escriba un Nombre de usuario , ó una lista de nombres_de_usuarios separados por comas.';
...
$string['mnetidproviderdesc'] = 'Usted puede emplear esta función para obtener un enlace con el que pueda entrar al sitio. Si puede proporcionar la dirección de correo electrónico correcta que coincida con el Nombre de usuario con el cual Usted intentó entrar previamente.';
