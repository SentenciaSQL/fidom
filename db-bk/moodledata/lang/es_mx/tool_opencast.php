...
/**
 * Strings for component 'tool_opencast', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['apiusername'] = 'Nombre de usuario para llamadas API';
...
$string['apiusernameempty'] = 'El Nombre de usuario para API de Opencast no está configurado correctamente; vaya a herramienta Opencast para corregir esto';
