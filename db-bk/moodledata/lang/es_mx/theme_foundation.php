...
/**
 * Strings for component 'theme_foundation', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['coursesmenuheading'] = 'Menú de cursos';
...
$string['loginbackgroundopacity'] = 'Opacidad de fondo de caja de ingreso cuando hay una imagen de fondo';
...
$string['swatchdesc'] = 'Elegir el swatch para el tema. Un \'Swatch\' es una manera de cambiar la apariencia del tema usando una lista de pre-configuraciones de definiciones a la que Usted anexa un nombre. Todos los swatches son de \'Bootswatch.com\' y están licenciados bajo la \'MIT License\'. Nota: Los Google font CDN\'s han sido eliminados debido a limitaciones con el compilador PHP SCSS y yo no quiero tener las complicaciones de actualizar también la privacidad.';
...
$string['syntaxhelpthree'] = 'Alias del pincel';
$string['syntaxhelptwo'] = 'Nombre del pincel';
$string['syntaxhighlight'] = 'Activar resaltado de sintaxis';
$string['syntaxhighlightcat'] = 'Categorías de cursos resaltar sintaxis';
...
$string['syntaxhighlightversion'] = 'Versión de resaltado de sintaxis';
$string['syntaxhighlightversiondesc'] = 'Seleccionar la versión que le gustaría usar.  elegir entre 3.0.83 y 4.0.1.';
