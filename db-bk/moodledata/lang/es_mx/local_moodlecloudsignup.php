...
/**
 * Strings for component 'local_moodlecloudsignup', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['FOSUserBundle:resetting.request.invalid_username'] = 'El Nombre de usuario o la dirección email para "%username%" no existe.';
$string['FOSUserBundle:resetting.request.submit'] = 'Reiniciar contraseña';
$string['FOSUserBundle:resetting.request.username'] = 'Nombre de usuario o dirección Email:';
...
<p>Usted puede ingresar a su sitio Moodle usando el Nombre de usuario "admin" y la contraseña que Usted mismo configuró al apuntarse.</p>
...
Usted puede ingresar a su sitio Moodle usando el Nombre de usuario "admin" y la contraseña que Usted mismo configuró al apuntarse.
...
$string['validators:fos_user.username.blank'] = 'Por favor escriba un Nombre de usuario';
$string['validators:fos_user.username.long'] = '[-Inf,Inf]El Nombre de usuario es demasiado largo';
$string['validators:fos_user.username.short'] = '[-Inf,Inf]El Nombre de usuario es demasiado corto';
