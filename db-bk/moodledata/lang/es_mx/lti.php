...
/**
 * Strings for component 'lti', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   lti
...
$string['resourcekey_admin_help'] = 'La clave del consumidor puede concebirse como un Nombre de usuario empleado para autenticar el acceso a la herramienta. Se puede emplear por el provedor de la herramienta para identificar inequívocamente al sitio Moodle desde donde los usuarios invocan la herramienta.
...
La clave del consumidor puede concebirse como un Nombre de usuario empleado para autenticar el acceso a la herramienta.  Se puede emplear por el provedor de la herramienta para identificar inequívocamente al sitio Moodle desde donde los usuarios invocan la herramienta.
