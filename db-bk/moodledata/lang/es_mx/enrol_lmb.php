...
/**
 * Strings for component 'enrol_lmb', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   enrol_lmb
...
$string['consolidateusershelp'] = 'Si un usuario no puede ser encontrado con el sourceid(idnumber) esperado, pero hay una coincidencia con Nombre de usuario , las cuentas serán consolidadas. Solamente use esta opción si Usted sabe que los nombres_de_usuarios son únicos y que no habrá colisiones.';
...
$string['ignoreusernamecase'] = 'Hacer Nombre de usuario en minúsculas';
...
$string['lmbusername'] = 'Nombre de usuario de Autenticación Remota';
...
$string['sourdidfallback'] = 'Proceda a usar sourceid si no encuentra username (Nombre de usuario )';
$string['sourdidfallbackhelp'] = 'Configurar el userid al sourceid de la persona en caso de no encontrar un Nombre de usuario . En general, los usuarios no se sabrán este número, por lo que no podrán ingresar, pero ésto creará la cuenta como un sustituíble (placeholder) hasta que se hayan recibido datos más completos.';
...
$string['usernamesource'] = 'Orígen del Nombre de usuario';
$string['usernamesourcehelp'] = 'Esto determina cual será el Nombre de usuario de los usuarios creados
<ul>
<li>Dirección Email completa: La direcciòn completa de Email es usada como Nombre de usuario .
