...
/**
 * Strings for component 'local_o365', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   local_o365
...
$string['acp_userconnections_column_o365user'] = 'Usuario de Office 365';
...
$string['acp_userconnections_filtering_musername'] = 'Nombre de usuario Moodle';
$string['acp_userconnections_filtering_o365username'] = 'Nombre de usuario Office 365';
$string['acp_userconnections_manualmatch_error_muserconnected'] = 'El usuario Moodle ya está conectado a un usuario Office 365';
$string['acp_userconnections_manualmatch_error_muserconnected2'] = 'El usuario Moodle ya está conectado a un usuario Office 365 (2)';
$string['acp_userconnections_manualmatch_error_musermatched'] = 'El usuario Moodle ya está apareado a un usuario Office 365';
$string['acp_userconnections_manualmatch_error_o365userconnected'] = 'El usuario Office 365 ya está conectado a otro usuario Moodle';
$string['acp_userconnections_manualmatch_error_o365usermatched'] = 'El usuario Office 365 ya está apareado a otro usuario Moodle';
$string['acp_userconnections_manualmatch_musername'] = 'Usuario Moodle';
$string['acp_userconnections_manualmatch_o365username'] = 'Nombre de usuario Office 365';
$string['acp_userconnections_manualmatch_title'] = 'Apareamiento manual de usuario';
$string['acp_userconnections_manualmatch_uselogin'] = 'Ingresar con Office 365';
...
$string['acp_usermatch_matchqueue_column_muser'] = 'Nombre de usuario Moodle';
$string['acp_usermatch_matchqueue_column_o365user'] = 'Nombre de usuario Office 365';
...
$string['healthcheck_ratelimit_result_passed'] = 'Las llamadas API Office 365 son ejecutados a toda velocidad.';
...
$string['privacy:metadata:local_o365_appassign:photoid'] = 'La ID de la foto del usuario en Office 365';
...
$string['privacy:metadata:local_o365_calsettings:o365calid'] = 'La ID del calendario en Office 365';
...
$string['privacy:metadata:local_o365_calsub:o365calid'] = 'La ID del calendario Office 365';
...
$string['privacy:metadata:local_o365_matchqueue:musername'] = 'El Nombre de usuario del usuario Moodle.';
$string['privacy:metadata:local_o365_matchqueue:o365username'] = 'El Nombre de usuario del usuario Office 365.';
...
$string['privacy:metadata:local_o365_objects:objectid'] = 'La ID del objeto de Office 365';
...
$string['privacy:metadata:local_o365_spgroupassign:groupid'] = 'La ID del grupo en Office 365';
...
$string['question_student_assignments_due'] = '¿Cuales tareas estarán pendientes a continuación?';
...
$string['question_teacher_assignments_for_grading'] = '¿Cuales tareas aun faltan de calificar?';
$string['question_teacher_assignments_incomplete_submissions'] = '¿Cuantas tareas tienen envíos incompletos?';
$string['question_teacher_last_logged_students'] = '¿Cuales estudiantes han ingresado al final a Moodle?';
$string['question_teacher_latest_logged_students'] = '¿Cuales estudiantes han ingresado más tarde a Moodle?';
...
$string['task_processmatchqueue_err_nomuser'] = 'No se encontraron usuarios Moodle con este Nombre de usuario';
$string['task_processmatchqueue_err_noo365user'] = 'No se encontraron usuarios Office 365 con este Nombre de usuario';
...
$string['ucp_connection_disconnected'] = 'Usted no está conectado a Office 365.';
$string['ucp_connection_linked'] = 'Enlazar sus cuentas Moodle y Office 365';
$string['ucp_connection_linked_migrate'] = 'Cambiar a cuenta enlazada.';
$string['ucp_connection_linked_start'] = 'Enlazar su cuenta Moodle a una cuenta Office 365.';
$string['ucp_connection_linked_stop'] = 'Des-enlazar su cuenta Moodle de la cuenta Office 365.';
