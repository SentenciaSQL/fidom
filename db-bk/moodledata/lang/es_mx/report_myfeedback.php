...
/**
 * Strings for component 'report_myfeedback', language 'es_mx', branch 'MOODLE_37_STABLE'
 *
...
$string['archivedbpassinfo'] = 'Contraseña Base de Datos archivada (para Nombre de usuario de arriba).';
$string['archivedbsettings'] = 'Configuraciones de BasedeDatos Archivada (no recomendado para intalaciones en producción)';
$string['archivedbuser'] = 'Nombre de usuario BasedeDatos archivada';
$string['archivedbuserinfo'] = 'Nombre de usuario BasedeDatos archivada (debería tener privilegios SELECT en BasedeDatos de arriba).';
...
$string['dbpassinfo'] = 'Contraseña de BasedeDatos remota (para el Nombre de usuario de arriba).<br />Déjelo vacío para usar la BasedeDatos por defecto de Moodle.';
$string['dbsettings'] = 'Configuraciones de BasedeDatos de Año Académico Actual';
$string['dbuser'] = 'Nombre de usuario DB';
$string['dbuserinfo'] = 'Nombre de usuario de base de datos remota (debería tener privilegios SELECT en la base de datos de arriba).<br />Déjelo vacío para usar la base de datos por defecto de Moodle.';
