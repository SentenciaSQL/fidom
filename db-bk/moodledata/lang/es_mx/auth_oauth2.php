...
/**
 * Strings for component 'auth_oauth2', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   auth_oauth2
...
$string['accountexists'] = 'Ya existe un usuario en este sitio con este Nombre de usuario. Si esta es su cuenta, ingrese al escribir su Nombre de usuario y contraseña y añádalo como un ingreso enlazado mediante su página de preferencias.';
...
$string['privacy:metadata:auth_oauth2:username'] = 'El Nombre de usuario externo que mapea a esta cuenta.';
