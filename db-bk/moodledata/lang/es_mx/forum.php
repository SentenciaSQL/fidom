...
/**
 * Strings for component 'forum', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   forum
...
$string['actionsforgraderinterface'] = 'Acciones para la interfase del valorador';
...
$string['duedate_help'] = 'Esto es cuando el foro está en fecha esperada. Aunque esta fecha es mostrada en el calendario como la fecha esperada, el publicar al foro todavía será permitido después de esta fecha. Para evitar la publicación al foro después de cierta fecha - configure una fecha de corte del foro.';
...
$string['forum:canoverridecutoff'] = 'Publicar a foros después de sus fechas de corte';
...
$string['gradeitemnameforrating'] = 'Calificación por valoración para {$a->name}';
$string['gradeitemnameforwholeforum'] = 'Calificación de todo el foro para {$a->name}';
