...
Si el Nombre de usuario y la contraseña son válidos, Moodle creará una nueva entrada de usuario en su BasedeDatos. Este módulo puede leer atributos del usuario desde LDAP y pre-llenar los campos necesarios en Moodle. Para los ingresos siguientes solamente se revisarán el Nombre de usuario y la contraseña.';
