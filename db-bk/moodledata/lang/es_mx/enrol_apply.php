...
/**
 * Strings for component 'enrol_apply', language 'es_mx', branch 'MOODLE_37_STABLE'
 *
 * @package   enrol_apply
...
$string['waitmailcontent_desc'] = 'Por favor, use las marcas especiales siguientes para remplazar el contenido del Email con datos de Moodle.<br/>{firstname}:Nombre(s) del usuario; {content}:El nombre del curso;{lastname}:Apellido(s) del usuario;{username}:El Nombre de usuario registrado del usuario';
