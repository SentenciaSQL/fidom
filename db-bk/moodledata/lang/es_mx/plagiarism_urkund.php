...
/**
 * Strings for component 'plagiarism_urkund', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['savedconfigfailed'] = 'Se ha escrito una combinación incorrecta de Nombre de usuario /contraseña, URKUND ha sido deshabilitado, por favor inténtelo de nuevo.';
...
$string['urkund_username'] = 'Nombre de usuario';
$string['urkund_username_help'] = 'Nombre de usuario proporcionado por URKUND para accesar el API';
