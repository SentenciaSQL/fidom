...
/**
 * Strings for component 'tool_behat', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   tool_behat
...
$string['errorapproot'] = '$CFG->behat_ionic_dirroot no está apuntando hacia una instalación de desarrollador de Moodle Mobile';
