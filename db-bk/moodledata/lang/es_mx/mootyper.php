...
/**
 * Strings for component 'mootyper', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   mootyper
...
$string['eaddnew'] = 'Añadir nuevo ejercicio / lección';
...
$string['timelimit_help'] = 'Si se habilita, se muestra una advertencia respecto al límite de tiempo arriba de la barra de estado. Cuando se alcanza el límite, el ejercicio es terminado. Si se configura a cero no hay límite de tiempo. Las letras tecleadas después de que el tiempo se haya agotado no son contadas.';
