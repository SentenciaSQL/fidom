...
/**
 * Strings for component 'webexactivity', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['apiusername'] = 'Nombre de usuario de Admin WebEx';
...
$string['badpassword'] = 'Su Nombre de usuario y contraseña de WebEx no coinciden.';
...
$string['prefix'] = 'Prefijo de Nombre de usuario';
...
$string['privacy:metadata:username'] = 'El Nombre de usuario del usuario que aloja una reunión.';
...
$string['privacy:metadata:webexactivity_recording:hostid'] = 'Nombre de usuario del host de una grabación';
$string['privacy:metadata:webexactivity_user'] = 'Usuarios del host Webex';
$string['privacy:metadata:webexactivity_user:webexid'] = 'Nombre de usuario Webex de un usuario Webex';
