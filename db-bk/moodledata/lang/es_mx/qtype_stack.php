...
/**
 * Strings for component 'qtype_stack', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   qtype_stack
...
$string['healthchecksamplecas'] = 'La derivada de {@ x^4/(1+x^4) @} es \\[ \\frac{d}{dx} \\frac{x^4}{1+x^4} = {@ diff(x^4/(1+x^4),x) @}. \\]  Confirme si unicode está soportado: \\(\\forall\\) debería de ser mostrado como {@unicode(2200)@}.';
...
$string['settingserveruserpass'] = 'Nombre de usuario:contraseña del usuario';
$string['settingserveruserpass_desc'] = 'Si Usted está usando Tipo de plataforma: Servidor, y si Usted ha configurado su servidor \'\'pool\'\' Maxima con autenticación HTTP, entonces Usted puede poner aquí el Nombre de usuario y la contraseña. Esto es ligeramente más seguro que ponerlos en la URL. El formato es Nombre de usuario:contraseña.';
