...
$string['form_text_help'] = 'Aquí puede Usted definir el texto que recibirán los estudiantes. Pueden usarse los siguientes remplazables: ###username### será remplazado con el Nombre de usuario del estudiante, ###usermail### con su correo y  ###coursename### con el nombre del curso actual.';
