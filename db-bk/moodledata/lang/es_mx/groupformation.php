...
/**
 * Strings for component 'groupformation', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['activity_visible'] = 'La actividad no es visible para Usted.';
...
$string['analysis_status_info0'] = 'Usted puede iniciar o terminar actividad';
$string['analysis_status_info1'] = 'Usted tiene que detener la actividad antes de la formación del grupo.';
$string['analysis_status_info2'] = 'Usted tiene que iniciar la actividad, de forma tal que los estudiantes puedan contestar el questionnaire.';
$string['analysis_status_info3'] = 'La formación del grupo ya ha iniciado o se está haciendo. La actividad ya no puede ser iniciada. Si Usted quiere iniciar otra vez la actividad, Usted necesita eliminar los grupos generados.';
$string['analysis_status_info4'] = 'Ahora Usted puede iniciar la formación del grupo.';
...
$string['availability_nochangespossible'] = 'El questionnaire ya ha sido contestado. Usted ya no puede cambiarle la disponibilidad.';
$string['bad'] = 'malo';
$string['beta_version'] = '';
$string['blbubl'] = 'neuroticismo,extraversión,escrupulosidad,amabilidad,apertura';
...
El profesor no tiene acceso directo a mis respuestas para la formacióndel grupo (solamente yo puedo acceeder a la evaluación acerca de mi personalidad y el promedio del grupo).
</li><li>
Mis datos personales serán eliminados cuando termine el curso - a más tardar en 360 días.</li></ul>';
$string['consent_opt_in'] = 'Consentimiento (si)';
$string['contact_members'] = 'Para contactar a los miembros de su equipo Usted puede hacer clic en sus Nombre de usuario.';
...
$string['dlfdss'] = 'reto, interés, probabilidad de éxito, misserfolgsbefuerchtung';
...
$string['grouping_status_0'] = 'Usted tiene que cerrar el questionnaire para iniciar la formación de grupo.';
...
$string['grouping_status_3'] = 'La terminación de la formación de grupo está en progreso.';
$string['grouping_status_4'] = 'La formación de grupo está terminada. Usted puede adoptar los grupos a Moodle o generar unos resultados nuevos por algoritmo.';
...
$string['group_overview'] = 'vista general de construir grupos';
$string['groups_build'] = 'Los grupos están construidos.';
...
$string['noGroup'] = 'Usted no ha sido asignado a ningun grupo porque Usted no contestó el questionnaire.';
...
$string['number_of_groups'] = 'Número de grupos construidos:';
$string['oneManGroup'] = 'Usted está en un grupo de una persona';
$string['onlyactivestudents'] = 'Solamente estudiantes con al menos una respuesta enviada deberían de considerarse para construir grupos.';
$string['onlyactivestudents_description'] = 'Solamente estudiantes con al menos una respuesta enviada deberían de considerarse para construir grupos.';
$string['onlyactivestudents_info'] = 'Solamente estudiantes con al menos una respuesta enviada serán considerados para la formación de grupos. Esto puede ser configurado en {$a->url}.';
...
$string['participant_code_example'] = 'Ejemplo: EV07AD11';
$string['participant_code_footer'] = 'Su código personal de participante es';
$string['participant_code_header'] = 'Por favor ingrese un código personal de participante basado en las siguientes reglas:';
$string['participant_code_rules'] = '1. El nombre de su madre (primeros dos caracteres, MAYÚSCULAS, EV para Eva)<br>
2. El mes de nacimiento de su madre (como dos dígitos,, z.B. 07 para Julioy)<br>
3. El nombre de su padre (primeros dos caracteres, MAYÚSCULAS, AD para Adán)<br>
4. El mes de nacimiento de su padre (como dos dígitos, , z.B. 11 para Noviembre)<br><br>
Remplace "Letras acentuadas" y caracteres especiales como sigue<br>
Á → A; Ó → O; Ú → U; Ñ → N';
...
$string['questionnaire_availability_info_from'] = 'El questionnaire está disponible en {$a->start} de la mañana.';
...
$string['questionnaire_availability_info_until'] = 'El cuestionario sigue en pie {$a->end} Reloj desbloqueado.';
...
$string['questionnaire_committed'] = 'Sus respuestas están enviadas. Usted no puede cambiarlas en esta actividad.';
...
$string['questionnaire_not_submitted'] = 'Sus respuestas aun no están enviadas.';
...
$string['students_enrolled_info'] = 'Estudiantes que están inscritos en este curso';
$string['students_grouping_multiple'] = 'estudiantes para construcción de grupo.';
$string['students_grouping_single'] = 'estudiantes para construcción de grupo.';
