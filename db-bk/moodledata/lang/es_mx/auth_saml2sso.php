...
$string['error_idpattr'] = 'Debe darse un atributo de mapeo de Nombre de usuario (username)';
...
$string['help_field_idp_fullname'] = '¿ Es un único campo el Nombre de usuario de IdP ? Si así fuera, llene con el mismo valor en los campos de nombre y apellido inferiores';
...
$string['help_moodle_mapping'] = '¿ Donde revisar si existe el Nombre de usuario ? Si se usa idnumber, recordar mapear in Mapeo de Datos abajo';
...
$string['label_idpattr'] = 'Mapeo de Nombre de usuario';
...
$string['label_moodle_mapping'] = 'Revisión de Nombre de usuario';
