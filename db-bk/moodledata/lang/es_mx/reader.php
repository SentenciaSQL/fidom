...
/**
 * Strings for component 'reader', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   reader
...
El Nombre de usuario y la contraseña son que Usted emplea para ingresar a  MoodleReader.org.
El Nombre de usuario debe de haber sido autorizado por el staff en MoodleReader.org.';
$string['configserverurl'] = 'La URL desde donde Usted puede descargar exámenes Moodle Reader para este sitio Moodle.';
$string['configserverusername'] = 'El Nombre de usuario necesario para descargar exámenes Moodle Reader para este sitio Moodle.';
...
$string['serverusername'] = 'Nombre de usuario para exámenes Reader';
...
$string['studentusername'] = 'Nombre de usuario del Estudiante';
...
$string['usernamenotfound'] = 'Nombre de usuario no encontrado: {$a}';
