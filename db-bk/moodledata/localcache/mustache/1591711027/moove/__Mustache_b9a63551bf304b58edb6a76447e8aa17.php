...
class __Mustache_b9a63551bf304b58edb6a76447e8aa17 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div class="cognito">
';
        $buffer .= $indent . '<script src="https://www.cognitoforms.com/s/jmzSyZ3X3EGWGw3zr6iY-g"></script>
';
        $buffer .= $indent . '<script>Cognito.load("forms", { id: "1" });</script>
';
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
