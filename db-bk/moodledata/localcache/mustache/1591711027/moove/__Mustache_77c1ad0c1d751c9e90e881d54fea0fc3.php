...
class __Mustache_77c1ad0c1d751c9e90e881d54fea0fc3 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</button>
';
        $buffer .= $indent . '			<a href="https://www.cognitoforms.com/AndresFrias/SolicitudDeInscripci%C3%B3nACurso" target="_blank" class="btn btn-primary" style="background-color: #F9D608; border-color: #F9D608">Solicitar Inscripción</a>
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </form>
